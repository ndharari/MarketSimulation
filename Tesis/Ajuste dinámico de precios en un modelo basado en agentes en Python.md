...
Mirando las dinámicas es posible diferenciar dos momentos distintos: en el primero, antes de haberse 
...
|                       | <u>Caso 1:</u> $S=1; B=2$                                    | <u>Caso 2:</u> $S=3; B=3$                                    | <u>Caso 3:</u> $S=4; B=3$                                    |
| --------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
| <br /><br /><br />$C$ | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/avg vs avg.svg" alt="avg vs avg" style="zoom: 25%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/avg vs avg-1593549461292.svg" alt="avg vs avg" style="zoom:25%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S4B3/avg vs avg.svg" alt="avg vs avg" style="zoom:25%;" /> |
| <br /><br /><br />$D$ | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Follow B.svg" alt="Follow B" style="zoom: 50%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Follow B-1593549469478.svg" alt="Follow B" style="zoom: 50%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Follow B-1593549611639.svg" alt="Follow B" style="zoom:50%;" /> |
| <br /><br /><br />$E$ | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Follow S.svg" alt="Follow S" style="zoom: 50%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Follow S-1593549482915.svg" alt="Follow S" style="zoom:50%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Follow S-1593549621632.svg" alt="Follow S" style="zoom:50%;" /> |
| <br /><br /><br />$F$ | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Heymann B.svg" alt="Heymann B" style="zoom:50%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Heymann B-1593549490845.svg" alt="Heymann B" style="zoom:50%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Heymann B-1593549635526.svg" alt="Heymann B" style="zoom:50%;" /> |
| <br /><br /><br />$G$ | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Heymann S-1593549390849.svg" alt="Heymann S" style="zoom:50%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Heymann S-1593549497401.svg" alt="Heymann S" style="zoom:50%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Heymann S-1593549642282.svg" alt="Heymann S" style="zoom:50%;" /> |
| <br /><br /><br />$H$ | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Inter-Intra B.svg" alt="Inter-Intra B" style="zoom: 25%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Inter-Intra B-1593549521751.svg" alt="Inter-Intra B" style="zoom: 25%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Inter-Intra B-1593549649334.svg" alt="Inter-Intra B" style="zoom: 25%;" /> |
| <br /><br /><br />$I$ | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Inter-Intra S-1593549443160.svg" alt="Inter-Intra S" style="zoom:25%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Inter-Intra S-1593549535316.svg" alt="Inter-Intra S" style="zoom: 25%;" /> | <img src="Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Inter-Intra S-1593549655479.svg" alt="Inter-Intra S" style="zoom: 25%;" /> |
...
|               |                  <u>Caso 1:</u> $S=1; B=2$                   |                  <u>Caso 2:</u> $S=3; B=3$                   |                  <u>Caso 3:</u> $S=5; B=3$                   |                  <u>Caso 4:</u> $S=10; B=5$                  |
| ------------- | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| <br/><br/>$A$ | ![17](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/17.png) | ![15](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/15.png) | ![48](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/48.png) | ![69](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S10B5/69.png) |
| <br/><br/>$B$ | ![74](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/74.png) | ![40](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/40.png) | ![78](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/78.png) | ![97](../../../../../Desktop/Simulations Result/Endurance = 3/S10 B5/Runs/97.png) |
...
|           |                  <u>Caso 1:</u> $S=1; B=2$                   |                  <u>Caso 2:</u> $S=3; B=3$                   |                  <u>Caso 3:</u> $S=5; B=3$                   |                  <u>Caso 4:</u> $S=10; B=5$                  |
| --------- | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: | :----------------------------------------------------------: |
| <br />$C$ | ![S1B2 - avg vs avg](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/S1B2 - avg vs avg.svg) | ![S3B3 - avg vs avg](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/S3B3 - avg vs avg.svg) | ![S5B3 - avg vs avg](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/S5B3 - avg vs avg.svg) | ![avg vs avg](../../../../../Desktop/Simulations Result/Endurance = 3/S10B5/Aggregate/avg vs avg.svg) |
| <br />$D$ | ![S1B2 - Follow B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/S1B2 - Follow B.svg) | ![S3B3 - Follow B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/S3B3 - Follow B.svg) | ![S5B3 - Follow B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/S5B3 - Follow B.svg) | ![Follow B](../../../../../Desktop/Simulations Result/Endurance = 3/S10B5/Aggregate/Follow B.svg) |
| <br />$E$ | ![S1B2 - Follow S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/S1B2 - Follow S.svg) | ![S3B3 - Follow S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/S3B3 - Follow S.svg) | ![S5B3 - Follow S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/S5B3 - Follow S.svg) | ![Follow S](../../../../../Desktop/Simulations Result/Endurance = 3/S10B5/Aggregate/Follow S.svg) |
| <br />$F$ | ![S1B2 - Heymann B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/S1B2 - Heymann B.svg) | ![S3B3 - Heymann B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/S3B3 - Heymann B.svg) | ![S5B3 - Heymann B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/S5B3 - Heymann B.svg) | ![S10B5 - Heymann B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S10B5/S10B5 - Heymann B.svg) |
| <br />$G$ | ![S1B2 - Heymann S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/S1B2 - Heymann S.svg) | ![S3B3 - Heymann S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/S3B3 - Heymann S.svg) | ![S5B3 - Heymann S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/S5B3 - Heymann S.svg) | ![S10B5 - Heymann S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S10B5/S10B5 - Heymann S.svg) |
| <br />$H$ | ![S1B2 - Inter-Intra B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/S1B2 - Inter-Intra B.svg) | ![S3B3 - Inter-Intra B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/S3B3 - Inter-Intra B.svg) | ![S5B3 - Inter-Intra B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/S5B3 - Inter-Intra B.svg) | ![S10B5 - Inter-Intra B](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S10B5/S10B5 - Inter-Intra B.svg) |
| <br />$I$ | ![S1B2 - Inter-Intra S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S1B2/S1B2 - Inter-Intra S.svg) | ![S3B3 - Inter-Intra S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S3B3/S3B3 - Inter-Intra S.svg) | ![S5B3 - Inter-Intra S](Ajuste dinámico de precios en un modelo basado en agentes en Python.assets/Endurance = 3/S5B3/S5B3 - Inter-Intra S.svg) | ![Inter-Intra S](../../../../../Desktop/Simulations Result/Endurance = 3/S10B5/Aggregate/Inter-Intra S.svg) |