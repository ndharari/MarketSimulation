...
class Market():
    ...
    def __init__(self, listSellers, listBuyers, maxrounds=50, echo=True):
        ...
        self.dinamicListSellers = list(listSellers) # Needs list() to create the double
        self.dinamicListBuyers = list(listBuyers) # Needs list() to create the double
        self.time = 0
        self.endOfTime = False
        self.maxrounds = maxrounds
        self.echo = echo # Shows text interface
        self.marketDataFrame = pd.DataFrame()
    ...
    def restart(self):
        ...
        """
        self.dinamicListSellers = list(self.staticListSellers) # Needs list() to create the double
        self.dinamicListBuyers = list(self.staticListBuyers) # Needs list() to create the double
        self.time = 0
        self.endOfTime = False
    ...
    def exchangeMechanism(self, pair):
        ...
        #TODO: change single value to list tracker for both traded and paired
    ...
    def dataFrameMaker(self):
        ...
        #TODO: refactor module to be market's main output!
        ...
        for agent in allAgents:
           # Checks nature of agents
            ...
            self.marketDataFrame = self.marketDataFrame.append(tempDf, ignore_index=True)
